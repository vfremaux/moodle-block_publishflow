...
$string['backupautomatedrunning'] = 'Automated backup is running. Execution delayed';
$string['backupcheckingcourse'] = 'Checking course...';
$string['backupcourse'] = 'Backuping course {$a}';
$string['backuperrornoadmin'] = 'Admin info is not available. Please report this to your moodle administration team.';
$string['backupfailure'] = 'Backup failure';
$string['backupfailure'] = 'The backup for publication has failed.';
$string['backupforpublishing'] = 'Backup for publication';
$string['backupinprogress'] = 'Previous backup is already running. please wait and try again in few minutes.';
$string['backuprelocfailure'] = 'The backup for publication could not be relocated.';
$string['backupstatecheck'] = 'Backup - checking backup engine availability.';
$string['backupstore'] = 'Storing backup in publishflow area.';
$string['backupsuccess'] = 'The backup for publication has completed.';
$string['badkey'] = 'The key given for deployment is not the expected one.';
$string['badresponse'] = ':&ensp;client failed to answer';
...
$string['choosetarget'] = 'Target:&ensp;';
$string['clientfailure'] = ':&ensp;The client failed to answer, it might be offline or it doesn\'t have the required service enabled.';
$string['close'] = 'Close';
...
$string['completed'] = 'has concluded. It has been assigned the following Unique Identifier:&ensp;{$a}';
$string['configclosedcategory'] = 'Closing Category';
$string['configcoursedeliveryislocal'] = 'Local Data Storage';
$string['configdefaultrole'] = 'Default role in incoming courses';
$string['configdeploycategory'] = 'Default Category';
$string['configdeployprofilefield'] = 'Profile field rule for deployment';
$string['configdeployprofilefieldvalue'] = 'Profile field expected value';
$string['configenableretrofit'] = 'Enable retrofeed of courses';
$string['configenablesessionmanagement'] = 'Enable course session management';
$string['configfactoryprefix'] = 'Factory prefix';
$string['configmainhostprefix'] = 'Main host prefix';
$string['configmoodlenodetype'] = 'Moodle Node Type';
$string['configpostprocessing'] = 'Processing scriptlet after course deployment';
$string['configpublicsessions'] = 'Allow Public Sessions';
$string['configrunningcategory'] = 'Active Category';
$string['configsubmitto'] = 'Submit config to';
$string['confirmjump'] = 'Continue?';
...
$string['coursecontrol'] = 'Course control:&ensp;';
...
$string['createdfields'] = 'Number of fields successfully created:&ensp;';
$string['datecreated'] = 'Creation date';
$string['defaultplatform'] = 'Local';
$string['deploy'] = 'Deploy';
$string['deployerrole'] = 'Deployer';
$string['deployerrole_desc'] = 'Deployers are usually editing teachers who can deploy the course to their authorised remote environements';
...
$string['enterkey'] = 'Key to deploy:&ensp;';
...
$string['errorencountered'] = ' has encountered an error:&ensp;';
$string['errormonitoring'] = 'It appears you have:&ensp;';
...
$string['failedfields'] = 'Number of failures:&ensp;';
$string['fieldname'] = 'Access to platform';
$string['finish'] = 'Finish';
$string['helpsynch'] = 'Synchronising platform';
$string['ignoredfields'] = 'Number of hosts ignored:&ensp;';
...
$string['notinpublishsystem'] = 'This moodle is not part of a publishing network';
...
$string['publishbackup'] = 'Make a backup for publishing';
...
$string['refreshbackup'] = 'Refresh backup';
$string['remotejumpadvice'] = 'This link quits the local platform and jumps to a remote moodle.';
...
$string['retrofitname'] = 'Back feed for sharing';
...
$string['scriptvalidator'] = 'Script validator';
...
$string['trace'] = 'Trace';
$string['unavailable'] = 'You must backup the course for sharing by clickng above before transfering.';
...
$string['networktransferadvice'] = 'Beware: delivering a complete path package through the network may spend some
amount of time. Although most common cases have been addressed with actual settings, the transfer of some
particularily big files may fail. Contact your system administrator.';

$string['configenablesessionmanagement_desc'] = 'If enabled, allows this block to operate course opening and closing, shifting between adequate categories.';

$string['configcoursedeliveryislocal_desc'] = 'Files won\'t be distributed by network transfers but through the local file system.
This option only works for moodles sharing the same storage area.';

$string['configenableretrofit_desc'] = 'If this option is enabled, course can be retrofitted to one of the known course
factory node(s) in the network.';

$string['configmoodlenodetype_desc'] = 'Configure Moodle Node Type';

$string['configrunningcategory_desc'] = 'Category for active sessions';

$string['configdeploycategory_desc'] = 'Course category for default deployment of courses';

$string['configclosedcategory_desc'] = 'Category for archived course sessions';

$string['configmainhostprefix_desc'] = 'Prefix of the main hosting platform';

$string['configfactoryprefix_desc'] = 'Prefix of the factory platform';

$string['configpostprocessing_desc'] = 'Write a moodlescript bit of code to be executed after a course has been restored';

$string['configpublicsessions_desc'] = 'If enabled, servers can provide you session lists without checking identity of the user';

$string['deploymentkey_desc'] = 'If a key is setup here, the user qill have to give that key to deploy. Leave blank to disable.';

$string['configdefaultrole_desc'] = 'This role is automatically assigned to the deployer in published, deployed or retrofitted
courses. Beware that this setting acts over courses that are pushed in in this Moodle. To set up a role on a remote
platform where to push out course volumes, you\'ll need to setup this setting on the remote platform.';
...
$string['closehelper'] = 'We strongly recomend you making <b>a complete backup of the course</b> (including user
files and data) and store a copy on your own. Take care that the "Generate a package" process DOES NOT perform a
complete backup, but only the content of the course for transfering the course structure to other nodes in the network.';

$string['closeprivatehelper'] = 'When being closed in "private mode", only administrators and trainers can see
the course content. Other users won\'t have any more access. Trainees will still remain enrolled within the session,
so opening back the course is straight away possible, using the course settings.';

$string['closeprotectedhelper'] = 'When being closed in "protected mode", all trainees are assigned a "disabled"
role, and will still have read access to the produced material.';

$string['closepublichelper'] = 'When being closed in "public mode", any authenticated user will be allowed to browse the
content of the course and all productions.';

$string['opennotifyhelper'] = 'Using this opening mode, you will give access to the training session workspace and
send an opening notification to all registered users in the course.';

$string['openwithoutnotifyhelper'] = 'Using this opening mode, you <b>silently</b> open the course session
for the users. No mail will be sent.';
...
$string['publishbackup_desc'] = 'A publishing backup is a backup wthout any user data stored into a specific
area dedicated to course transport between moodle instances.';

$string['configdeployprofilefield_desc'] = 'Alternatively to a capability authorisation, users may be allowed to deploy on
this moodle on a profile field test base. Enter the profile field identifier (primary field as &lt;fieldname&gt;, or custom profile field
as profile_field_&lt;fieldshort&gt;) to be tested.';
