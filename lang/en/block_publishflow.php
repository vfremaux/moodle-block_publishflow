...
$string['publishbackup_desc'] = 'A publishing backup is a backup wthout any user data stored into a specific area dedicated to course transport between moodle instances.';
