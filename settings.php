...
$courses = get_records_menu('course', '', '', 'shortname', 'id,shortname');
...
$categoriesoptions = get_records_menu('course_categories', '', '', '', 'id, name');
...
$roleoptions = array_merge(array('0' => get_string('noassignation', 'block_publishflow')), get_records_menu('role', '', '', 'id,name'));
